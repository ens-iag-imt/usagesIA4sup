---
title: Réussir ses études
layout: default
parent: Étudiant
nav_order: 2
--- 

# Réussir ses études avec l’IA générative 
...
Vous pouvez réussir vos études sans IA générative. Si vous pensez qu’elle peut vous aider, ce guide vise à vous préciser ce qui est possible ou non, et à vous proposer des exemples pour vous aider dans la réussite de vos études. 
...
* [Perplexity](http://perplexity.ai) pour la recherche internet, et son [navigateur dédié Comet](https://www.perplexity.ai/fr/comet/gettingstarted), intégrant directement l’IA, et permettant d’utiliser différents modèles du marché ; 
...
Quelques outils intéressants pour les étudiants : 
...
* [Mode "étudier" de ChatGPT](https://openai.com/fr-FR/index/chatgpt-study-mode/) qui vous permet d’utiliser chatGPT de manière à être accompagné dans un travail de réflexion plutôt que d’obtenir des réponses. De manière similaire, Gemini propose une option [apprentissage guidé](https://blog.google/outreach-initiatives/education/guided-learning/). 
