...
Une des premières interactions, peut également être de demander à l’IAg de suggérer une telle décomposition. Cette interaction pourra être renouvelée lorsque vous le souhaiterez nécessaire. À vous d‘évaluer cette décomposition pour construire le processus qui vous convient.   
